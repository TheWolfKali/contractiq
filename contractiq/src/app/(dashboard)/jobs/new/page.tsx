            ...
            {photos.length < MAX_PHOTOS && (
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="border-2 border-dashed border-gray-300 rounded-2xl py-8 flex flex-col items-center gap-2 hover:border-slate-400 hover:bg-slate-50 transition-colors"
                >
